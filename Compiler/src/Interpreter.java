 ...
 * The main program of the Interpreter should correspond to the general function of an interpreter, 
 * i.e. the fetch-decode-execute cycle.
 * If the Interpreter encounters an invalid operator, 
 * or if there are not sufficently many arguments for an operator on the stack, 
 * then it should write out the error message: Error for operator: nameOfOperator 
